...
public class CpfAttribute : ValidationAttribute
    {
        ...
        {
            return Cpf.IsValid(value.ToString()) ? ValidationResult.Success : new ValidationResult(errorMessage: "CPF em formato inválido.");
        }
    }
    ...
    public class CpfValidationAttributeProvider : IValidationAttributeAdapterProvider
    {
